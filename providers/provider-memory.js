...
Provider.prototype.getApps = function (callback) {
    callback(null, apps);
};

Provider.prototype.getUsers = function (appId, callback) {
    var retVal = _.filter(users, function(user) {
        return user.APP_ID == appId;
    });
